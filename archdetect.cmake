# Learning Focus CMake Target Architecture Detector File 2.0.0
# This source code file is copied from GitHub: https://github.com/axr/solar-cmake/blob/master/TargetArch.cmake.
# Copyright (c) 2012 - 2023 The AXR Project
# Contributors: jakepetroules
set(ARCH_DETECT_C_CODE "
...
function(target_architecture output_var)
	file(WRITE "${CMAKE_BINARY_DIR}/archdetect.cpp" "${ARCH_DETECT_C_CODE}")
	enable_language(C)
	try_run(run_result_unused compile_result_unused "${CMAKE_BINARY_DIR}" "${CMAKE_BINARY_DIR}/archdetect.cpp" COMPILE_OUTPUT_VARIABLE ARCH CMAKE_FLAGS CMAKE_ARCHITECTURES=${CMAKE_OSX_ARCHITECTURES}
	)
